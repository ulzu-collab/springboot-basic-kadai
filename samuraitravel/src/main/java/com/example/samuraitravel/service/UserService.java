...
public class UserService {
	...
	@Transactional // トランザクション＝データベースの操作をひとまとめにしたもの。
	public User createUser(SignupForm signupForm) {
		...
		user.setPassword(passwordEncoder.encode(signupForm.getPassword())); // パスワードはencode()でハッシュ化する。
		user.setRole(role);
	...
	public boolean isSamePassword(String password, String passwordConfirmation) {
		return password.equals(passwordConfirmation); // equals()で文字列同士を比較できる。
	}
