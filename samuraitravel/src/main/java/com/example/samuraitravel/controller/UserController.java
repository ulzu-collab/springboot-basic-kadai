...
public class UserController {
	...
	@GetMapping
	public String index(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl, Model model) { // ログイン中のユーザーの情報を引数で受け取る。
	...
	@PostMapping("/update")
	// フォームから送信されたデータを引数にバインド（割り当て）する。同時にバリデーションを行う。
